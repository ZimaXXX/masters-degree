...
\author{Tomasz Merda}                              % Your name comes here
\title{Ocena jakości rozpoznawania gestśw statycznych przy użyciu technologii
Microsoft~Kinect}                   % Note how we protect the final title phrase from breaking
\ppsupervisor{~dr~inż.~Mikołaj Sobczak} % Your supervisor comes here.
\ppyear{2012}                                         % Year of final submission
% (not graduation!)
